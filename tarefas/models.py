...
class Tarefa(models.Model):
    ...
    situacao = models.CharField(max_length=1, choices=SITUACAO, default='P')
    pessoa = models.ForeignKey(Pessoa, related_name="tarefas", null=True, on_delete=models.CASCADE)
